                        ...
                        <div className="">
                            <div className="flex flexwrap">
                                ...
                                Tensorflow.js layers api (similar to the keras api). Adam optimizer is used with a learning rate of 0.01
                                    and a mean square error loss function is used.
                                    As training progresses, model's weights are updated to minimize the difference between the encoder input 
                                    ...
                                    the histrogram of reconstruction error generated by the momdel. At initialization, the untrained model 
                                   the autoencoder has not learned to reconstruct normal data and hence makes fairly random guesses in its attempt
